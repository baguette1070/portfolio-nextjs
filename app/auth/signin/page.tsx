...
export default function SignIn(props: {
  ...
  useEffect(() => {
    props.searchParams.then((searchParams) => {
      if (searchParams["signup-success"] === "true") {
        toast.success(
              ...
              onClick={async () => {
                await signIn.email(
                  ...
                  },
                  {
                    onRequest: () => {
                      setLoading(true);
                      toastId.current = toast.loading("Sign in in progress...");
                    },
                    onResponse: () => {
                      setLoading(false);
              ...
              <Button
                ...
                onClick={async () => {
                  await signIn.social(
                    ...
                    {
                      onRequest: () => {
                        toast.loading("Sign in in progress...");
                        setLoading(true);
                      },
                      onResponse: () => {
                        setLoading(false);
        ...
        <CardFooter>
          ...
          >
            <p className="text-center text-xs text-neutral-500">
              {" "}
              <span className="text-neutral-500-400 underline">Sign up</span>
            </p>
          </Link>
        </CardFooter>
      </Card>
